...
.howto{counter-reset:step}.howto-step{display:flex;gap:12px;padding:12px 0;border-bottom:1px dashed var(--line)}.howto-step:last-child{border-bottom:0;padding-bottom:0}.howto-num{flex:none;width:26px;height:26px;border-radius:9px;display:grid;place-items:center;font-size:11px;font-weight:900;background:linear-gradient(135deg,var(--accent),var(--cyan));color:#fff}.howto-txt b{display:block;font-size:10.5px;margin-bottom:3px}.howto-txt small{display:block;color:var(--soft);font-size:8.5px;line-height:1.8}
.quickadd{display:grid;grid-template-columns:repeat(2,1fr);gap:7px;margin-top:10px}.qa-btn{padding:9px 8px;border-radius:11px;border:1px solid var(--line);background:#0d141f;color:#dfe6ef;font:800 8.5px Vazirmatn;text-decoration:none;text-align:center;display:flex;align-items:center;justify-content:center;gap:5px;transition:transform .15s ease,border-color .15s ease}.qa-btn:hover{transform:translateY(-1px);border-color:rgba(139,92,246,.4)}
...
<aside><div class="panel"><div class="head"><div><b>راهنمای اتصال سریع</b><small>سه قدم تا اتصال</small></div></div><div class="body howto"><div class="howto-step"><div class="howto-num">۱</div><div class="howto-txt"><b>اپ مناسب را نصب کن</b><small>یکی از کلاینت‌های پیشنهادی پایین همین صفحه را روی دستگاهت نصب کن.</small></div></div><div class="howto-step"><div class="howto-num">۲</div><div class="howto-txt"><b>لینک اشتراک را وارد کن</b><small>روی «➕ افزودن سریع» بزن یا لینک را کپی/اسکن کن و داخل اپ در بخش Subscription وارد کن.</small></div></div><div class="howto-step"><div class="howto-num">۳</div><div class="howto-txt"><b>بروزرسانی و اتصال</b><small>لیست کانفیگ‌ها را بروزرسانی (Update) کن، یکی را انتخاب و متصل شو.</small></div></div></div></div><div class="panel" style="margin-top:13px"><div class="head"><div><b>پروفایل اتصال</b><small>روی هر کارت بزن تا کپی بشه</small></div></div><div class="body"><div class="info-grid"><div class="fact" onclick="copyFact(this)"><small>Protocol</small><b dir="ltr">__PROTOCOL__</b><i class="fact-copy">⧉</i></div><div class="fact" onclick="copyFact(this)"><small>Network</small><b dir="ltr">__NETWORK__</b><i class="fact-copy">⧉</i></div><div class="fact" onclick="copyFact(this)"><small>Security</small><b dir="ltr">__SECURITY__</b><i class="fact-copy">⧉</i></div><div class="fact" onclick="copyFact(this)"><small>Address</small><b dir="ltr">__ADDRESS__</b><i class="fact-copy">⧉</i></div></div></div></div><div class="panel" style="margin-top:13px"><div class="head"><div><b>کلاینت‌های پیشنهادی</b><small>Import subscription in one step</small></div></div><div class="body"><div class="apps"><a class="app" href="https://github.com/2dust/v2rayNG/releases/latest" target="_blank"><div class="app-ico" style="background:rgba(34,197,139,.14);color:#22c58b">🤖</div><b>v2rayNG</b><small>Android</small></a><a class="app" href="https://github.com/2dust/v2rayN/releases/latest" target="_blank"><div class="app-ico" style="background:rgba(53,214,255,.14);color:#35d6ff">🖥️</div><b>v2rayN</b><small>Desktop</small></a><a class="app" href="https://github.com/hiddify/hiddify-app/releases/latest" target="_blank"><div class="app-ico" style="background:rgba(139,92,246,.14);color:#a997ff">🌐</div><b>Hiddify</b><small>Multi-platform</small></a></div><div class="quickadd" style="grid-template-columns:1fr 1fr"><a class="qa-btn" href="__QA_SINGBOX__">➕ sing-box</a><a class="qa-btn" href="__QA_STREISAND__">➕ Streisand (iOS)</a></div></div></div></aside></div><div class="footer">VodiWalker · Premium Subscription Center · Live update enabled</div></main><div class="toast" id="toast">کپی شد ✓</div>
